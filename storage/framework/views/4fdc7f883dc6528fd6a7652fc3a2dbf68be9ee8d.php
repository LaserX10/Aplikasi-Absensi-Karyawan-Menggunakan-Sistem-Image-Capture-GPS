...
<div class="row" style="margin-top:70px">
    <div class="col">
        <form method="POST" action="/izinsakit/<?php echo e($dataizin->kode_izin); ?>/update" id="frmIzin" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="form-group">
                <input type="text" id="tgl_izin_dari" value="<?php echo e($dataizin->tgl_izin_dari); ?>" autocomplete="off" name="tgl_izin_dari" 
                class="form-control datepicker" placeholder="Dari">
            </div>
            <div class="form-group">
                <input type="text" id="tgl_izin_sampai" value="<?php echo e($dataizin->tgl_izin_sampai); ?>" autocomplete="off" 
            ...
            <?php if($dataizin->doc_skd != null): ?>
                <div class="row">
                    <div class="col-12">
                        <?php
                        $docskd = Storage::url('/uploads/skd/' . $dataizin->doc_skd );
                        ?>
                        <img src="<?php echo e(url($docskd)); ?>" alt="" width="100px">
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="form-group">
                <input type="text" id="keterangan" value="<?php echo e($dataizin->keterangan); ?>" name="keterangan" class="form-control" 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.presensi', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyek Penelitian\presensigps\resources\views/sakit/edit.blade.php ENDPATH**/ ?>