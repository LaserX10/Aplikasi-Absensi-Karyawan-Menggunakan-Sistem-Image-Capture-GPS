      ...
      <div class="row g-2 align-items-center">
        <div class="col">
          ...
          <div class="page-pretitle">
            <h3>
              Rekap Presensi <?php echo e(date("d-m-Y", strtotime(date('Y-m-d')))); ?>
                ...
                <div class="card card-sm">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <div class="font-weight-medium">
                            <?php echo e($rekappresensi->jmlizin); ?>
                ...
                <div class="card card-sm">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <div class="font-weight-medium">
                            <?php echo e($rekappresensi->jmlsakit); ?>
                ...
                <div class="card card-sm">
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <div class="font-weight-medium">
                            <?php echo e($rekappresensi->jmlcuti); ?>
...
<?php echo $__env->make('layouts.admin.tabler', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyek Penelitian\presensigps\resources\views/dashboard/dashboardadmin.blade.php ENDPATH**/ ?>